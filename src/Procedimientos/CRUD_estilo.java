...
import static Interfaces.Modificar_Estilo.Nombre_estilo;
...
public class CRUD_estilo {
    ...
    public void cargarDatosListaModificar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Nombre_estilo.setText(rs.getString("nombre"));
    ...
    public void Modificar_estilo() {
        ...
        try {
            ...
            s = connection.createStatement();
            int z = s.executeUpdate("UPDATE estilo SET id_estilo = '" + Codigo + "', nombre = '" + nombre + "' WHERE id_marca = '" + estilo.getCodigo_estilo() + "'");
            if (z == 1) {
